...
status: archived
archived_sprint: sprint-59
archived_reason: "The frontend zone this described (the sprint-23/24 + sprint-38 second attempt: AppShell/nav/per-tab features/theme system/Table-UptimeBar-Timeline) was deleted in the greenfield rebuild (STORY-120/121/122, PO decision 2026-07-21). Superseded by the rewritten frontend-zone.md."
---

> **ARCHIVED sprint-59 (STORY-120/121/122)** — the frontend zone this described (the
> sprint-23/24 + sprint-38 "second attempt": AppShell.tsx, nav/, the six per-tab feature
> modules, the theme system, and the Table/UptimeBar/Timeline primitives) was **deleted** in
> the greenfield rebuild (PO decision 2026-07-21, after two rejected attempts). Superseded by
> the rewritten [[frontend-zone]]. Retained for history only — **everything below is
> past-tense; none of it is live code.**
