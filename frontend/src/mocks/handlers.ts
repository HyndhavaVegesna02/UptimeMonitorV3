...
/**
 * Default success handlers backing the Vitest suite (STORY-015a AC3). Tests
 * override with `server.use(...)` for the error/retry paths — MSW is the
 * only mocked I/O edge; nothing mocks the api client or the hook itself.
 */
