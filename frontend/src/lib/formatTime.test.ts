...
describe('formatRelativeTime', () => {
  ...
  it('never crashes on invalid input — renders the raw string instead', () => {
...
describe('formatTooltip', () => {
  it('embeds the raw ISO-UTC instant so it is always available', () => {
...
describe('formatLocalRange', () => {
  it('renders a local time range with an explicit timezone label, and the raw UTC range in the tooltip', () => {
  ...
  it('never crashes on invalid input — renders the raw strings instead', () => {
