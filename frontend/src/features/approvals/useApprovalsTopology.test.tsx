...
import { useApprovalsTopology } from './useApprovalsTopology'

/** Minimal harness, mirroring `features/dashboard/useTopology.test.tsx`'s
 * pattern — a thin `useFetch(getTopology)` wrapper for the Approvals tab. */
function Harness() {
  const { state, retry } = useApprovalsTopology()
