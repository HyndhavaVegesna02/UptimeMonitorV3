 ...
 * (STORY-099 AC2 — the Dashboard's "Maintenance" cross-tab awareness card):
 * an operator cares about a window that's live right now or scheduled to
 * start, not one that's already finished. Mirrors
