...
describe('RelativeTime', () => {
  ...
  it('renders a <time dateTime> carrying the raw ISO instant, with the relative text as content', () => {
  ...
  it('carries the absolute-local + raw-UTC tooltip in `title`', () => {
    const now = () => new Date('2026-07-17T12:00:00.000Z')
    render(<RelativeTime iso={ISO} now={now} />)
  ...
  it('passes through a className (e.g. the shared mono token)', () => {
    const now = () => new Date('2026-07-17T12:00:00.000Z')
  ...
  it('updates at least once a minute while mounted', () => {
    vi.useFakeTimers()
